...
if (isset($_POST["bsimpan"])) {
	...
	$simpan = mysqli_query($connection, "INSERT INTO akun VALUES ('','$nama','$email','$alamat','$hp')");
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="Masukan Email Anda" required autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label for="">Alamat</label>
                                <input type="text" name="alamat" class="form-control" placeholder="Masukan Alamat Anda" required autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label for="">No. HP</label>
                                <input type="text" name="hp" class="form-control" placeholder="Masukan No. HP Anda" required autocomplete="off">
                            </div>
